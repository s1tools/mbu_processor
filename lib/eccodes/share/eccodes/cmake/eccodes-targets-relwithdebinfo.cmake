...
set_target_properties(eccodes PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELWITHDEBINFO "/usr/lib64/libm.so;-lpthread"
...
list(APPEND _IMPORT_CHECK_FILES_FOR_codes_info "${_IMPORT_PREFIX}/bin/codes_info" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_codes_count "${_IMPORT_PREFIX}/bin/codes_count" )
...
set_target_properties(grib_merge PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/bin/grib_merge"
  )

list(APPEND _IMPORT_CHECK_TARGETS grib_merge )
list(APPEND _IMPORT_CHECK_FILES_FOR_grib_merge "${_IMPORT_PREFIX}/bin/grib_merge" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_codes_parser "${_IMPORT_PREFIX}/bin/codes_parser" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_bufr_ls "${_IMPORT_PREFIX}/bin/bufr_ls" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_bufr_dump "${_IMPORT_PREFIX}/bin/bufr_dump" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_bufr_set "${_IMPORT_PREFIX}/bin/bufr_set" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_bufr_get "${_IMPORT_PREFIX}/bin/bufr_get" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_bufr_copy "${_IMPORT_PREFIX}/bin/bufr_copy" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_bufr_compare "${_IMPORT_PREFIX}/bin/bufr_compare" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_bufr_index_build "${_IMPORT_PREFIX}/bin/bufr_index_build" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_gts_get "${_IMPORT_PREFIX}/bin/gts_get" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_gts_compare "${_IMPORT_PREFIX}/bin/gts_compare" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_gts_copy "${_IMPORT_PREFIX}/bin/gts_copy" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_gts_dump "${_IMPORT_PREFIX}/bin/gts_dump" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_gts_filter "${_IMPORT_PREFIX}/bin/gts_filter" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_gts_ls "${_IMPORT_PREFIX}/bin/gts_ls" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_metar_dump "${_IMPORT_PREFIX}/bin/metar_dump" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_metar_ls "${_IMPORT_PREFIX}/bin/metar_ls" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_metar_compare "${_IMPORT_PREFIX}/bin/metar_compare" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_metar_get "${_IMPORT_PREFIX}/bin/metar_get" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_metar_filter "${_IMPORT_PREFIX}/bin/metar_filter" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_metar_copy "${_IMPORT_PREFIX}/bin/metar_copy" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_bufr_count "${_IMPORT_PREFIX}/bin/bufr_count" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_codes_bufr_filter "${_IMPORT_PREFIX}/bin/codes_bufr_filter" )
...
set_target_properties(eccodes_f90 PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELWITHDEBINFO "eccodes"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libeccodes_f90.so"
  IMPORTED_SONAME_RELWITHDEBINFO "libeccodes_f90.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS eccodes_f90 )
list(APPEND _IMPORT_CHECK_FILES_FOR_eccodes_f90 "${_IMPORT_PREFIX}/lib/libeccodes_f90.so" )
...
set_target_properties(tigge_check PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/bin/tigge_check"
  )
...
# Import target "tigge_name" for configuration "RelWithDebInfo"
set_property(TARGET tigge_name APPEND PROPERTY IMPORTED_CONFIGURATIONS RELWITHDEBINFO)
set_target_properties(tigge_name PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/bin/tigge_name"
  )

list(APPEND _IMPORT_CHECK_TARGETS tigge_name )
list(APPEND _IMPORT_CHECK_FILES_FOR_tigge_name "${_IMPORT_PREFIX}/bin/tigge_name" )

# Import target "tigge_accumulations" for configuration "RelWithDebInfo"
set_property(TARGET tigge_accumulations APPEND PROPERTY IMPORTED_CONFIGURATIONS RELWITHDEBINFO)
set_target_properties(tigge_accumulations PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/bin/tigge_accumulations"
  )
...
# Import target "tigge_split" for configuration "RelWithDebInfo"
set_property(TARGET tigge_split APPEND PROPERTY IMPORTED_CONFIGURATIONS RELWITHDEBINFO)
set_target_properties(tigge_split PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/bin/tigge_split"
  )

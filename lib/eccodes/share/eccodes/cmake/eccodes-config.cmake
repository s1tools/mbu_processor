...
set( ECCODES_TPL_INCLUDE_DIRS  "/usr/lib64/python2.6/site-packages/numpy/core/include" )
set( ECCODES_TPL_DEFINITIONS   "" )
set( ECCODES_TPL_LIBRARIES     "/usr/lib64/libm.so" )

set( ECCODES_VERSION           "2.1.0" )
...
set( ECCODES_FEATURES    "TESTS;EXAMPLES;JPG;NETCDF;PYTHON;FORTRAN" )
...
if( NOT eccodes_BINARY_DIR )
  ...
  if( ECCODES_IS_BUILD_DIR_EXPORT )
    include( "/usr/local/components/MBU-1.0/lib/eccodes/eccodes-2.1.0-Source/build/eccodes-targets.cmake" OPTIONAL )
  else()
    include( "${ECCODES_CMAKE_DIR}/eccodes-targets.cmake" )
  endif()
...
if( NOT eccodes )
  if( ECCODES_IS_BUILD_DIR_EXPORT )
    set( eccodes_BASE_DIR /usr/local/components/MBU-1.0/lib/eccodes/eccodes-2.1.0-Source/build )
  else()

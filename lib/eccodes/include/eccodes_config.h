...
#define ECCODES_DEFINITION_PATH      "/usr/local/components/MBU/lib/eccodes/share/eccodes/definitions"
...
#define ECCODES_SAMPLES_PATH    "/usr/local/components/MBU/lib/eccodes/share/eccodes/samples"

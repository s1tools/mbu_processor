...
class JobOrder(object):
    ...
    def readInputs(self):
        ...
        self.Inputs['count_ListOfInputs']=str(self.treeJobOrder.find(".//List_of_Inputs/Input/List_of_File_Names").get('count'))
    ...
    def startCore(self):
        ...
        for iinputNETCDF in self.listManifest['ntcdfFilename']:
            ...
            try:
                ...
                crc=crcOCNproduct
                obj_nc2bufr=bufr_encode_sentinel1.netcdfToBufr(iinputNETCDF,pathOutput,crc)

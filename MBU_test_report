...
|MBU_REG_009	|Centos 7  - Non regression WD_MBU_PROC-000001|  	0 PASSED  
26 FAILED	|PASSED  
The failed tests are related to a change in the way to managed fill value in MBU Process. This behavior is expected. |
MBU_REG_010	Centos 7  - Non regression WD_MBU_PROC-000002	4 PASSED
62 FAILED	PASSED
The failed tests are related to a change in the way to managed fill value in MBU Process. This behavior is expected
MBU_REG_011	Centos 7  - Non regression WD_MBU_PROC-000003	33 PASSED
115 FAILED	PASSED
The failed tests are related to a change in the way to managed fill value in MBU Process. This behavior is expected
MBU_REG_012	Centos 7  - Non regression WD_MBU_PROC_00BDBA  	6 PASSED
40 FAILED	PASSED
The failed tests are related to a change in the way to managed fill value in MBU Process. This behavior is expected
MBU_REG_013	Centos 7  - Non regression WD_MBU_PROC-0122F4_IPF290	23 PASSED
53 FAILED	PASSED
The failed tests are related to a change in the way to managed fill value in MBU Process. This behavior is expected
MBU_REG_014	Centos 7  - Non regression WD_MBU_PROC_020265	10 PASSED
14 FAILED	PASSED
The failed tests are related to a change in the way to managed fill value in MBU Process. This behavior is expected
MBU_REG_015	Centos 7  - Non regression WD_MBU_PROC_0202AC	22 PASSED
46 FAILED	PASSED
The failed tests are related to a change in the way to managed fill value in MBU Process. This behavior is expected
MBU_REG_016	Centos 7  - Non regression WD_MBU_PROC_024190_IPF290	21 PASSED
77 FAILED	PASSED
The failed tests are related to a change in the way to managed fill value in MBU Process. This behavior is expected

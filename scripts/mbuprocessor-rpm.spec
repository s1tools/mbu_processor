%{!?__python3: %global __python3 /usr/local/components/MBU-2.0/bin/python3.7}
%global __python %{__python3}
%global _pylib /usr/local/components/MBU-2.0/lib/python3.7/site-packages
...
VERSIONNED_FOLDER_NAME="MBU-2.0"
